...
final class h00 {
        ...
        while (i3 < i + i2) {
            ...
            switch (charAt) {
                ...
                case 65531:
                    ...
                    i3 = i13 + 1;
                    sb.append(a.format(i14 + bArr[i3]));
                    break;
            }
            int i15 = i5 - 1;
            if (i5 == 0) {
    ...
    public static kz a(byte[] bArr, int i) {
        StringBuilder sb;
        int i2;
        StringBuilder sb2 = new StringBuilder(144);
        if (i == 2 || i == 3) {
            int i3 = 0;
            String format = i == 2 ? new DecimalFormat("0000000000".substring(0, c(bArr))).format(b(bArr)) : d(bArr);
            String format2 = b.format(a(bArr));
            String format3 = b.format(e(bArr));
        ...
        return new kz(bArr, sb2.toString(), null, String.valueOf(i));
    }
    ...
    private static String d(byte[] bArr) {
        return String.valueOf(new char[]{c[0].charAt(a(bArr, new byte[]{39, 40, 41, 42, 31, 32})), c[0].charAt(a(bArr, new byte[]{33, 34, 35, 36, 25, 26})), c[0].charAt(a(bArr, new byte[]{27, 28, 29, 30, 19, 20})), c[0].charAt(a(bArr, new byte[]{21, 22, 23, 24, 13, 14})), c[0].charAt(a(bArr, new byte[]{15, 16, 17, 18, 7, 8})), c[0].charAt(a(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
