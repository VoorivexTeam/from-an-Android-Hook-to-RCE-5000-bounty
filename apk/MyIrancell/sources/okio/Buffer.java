...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m14632of(messageDigest.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m14632of(mac.doFinal());
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x00ad A[EDGE_INSN: B:47:0x00ad->B:41:0x00ad BREAK  A[LOOP:0: B:4:0x000f->B:46:?], SYNTHETIC] */
