...
public class C2537h4 {
    /* renamed from: a */
    public static Interpolator m12092a(Context context, int i) {
        ...
        try {
            try {
                ...
                Interpolator m12093a = m12093a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return m12093a;
    ...
    */
    private static android.view.animation.Interpolator m12093a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) {
        /*
            int r3 = r5.getDepth()
            r4 = 0
        L5:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C2537h4.m12093a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
