...
final class g00 {
    ...
    public byte[] m11862a() {
        ...
        int m12297c = this.f10183a.m12297c();
        int m12300h = this.f10183a.m12300h();
        for (int i = 0; i < m12297c; i++) {
            int[] iArr = f10182b[i];
            for (int i2 = 0; i2 < m12300h; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f10183a.m12295b(i2, i)) {
                    int i4 = i3 / 6;
