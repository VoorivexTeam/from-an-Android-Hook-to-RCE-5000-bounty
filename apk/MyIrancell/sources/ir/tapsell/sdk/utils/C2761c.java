...
/* renamed from: ir.tapsell.sdk.utils.c */
/* loaded from: classes.dex */
public class C2761c {
    @SuppressLint({"NewApi"})
    /* renamed from: a */
    public static Bitmap m13135a(Context context, boolean z, Bitmap bitmap, int i) {
        Bitmap bitmap2;
        int i2;
        int i3;
        int[] iArr;
        ...
        while (i44 < width) {
            ...
            int i65 = 0;
            while (i65 < i63) {
                iArr15[i60] = (iArr15[i60] & (-16777216)) | (iArr13[i56] << 16) | (iArr13[i64] << 8) | iArr13[i62];
                int i66 = i56 - i48;
                int i67 = i64 - i49;
                int i68 = i62 - i50;
                int[] iArr17 = iArr9[((i61 - i4) + i46) % i46];
