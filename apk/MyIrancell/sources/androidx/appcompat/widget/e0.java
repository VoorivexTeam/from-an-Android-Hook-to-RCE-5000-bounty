...
public abstract class e0 implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = e0.this.e.getParent();
            if (parent != null) {
    ...
    private boolean a(MotionEvent motionEvent) {
        c0 c0Var;
        View view = this.e;
        androidx.appcompat.view.menu.s a2 = a();
        if (a2 == null || !a2.d() || (c0Var = (c0) a2.b()) == null || !c0Var.isShown()) {
            return false;
        }
        MotionEvent obtainNoHistory = MotionEvent.obtainNoHistory(motionEvent);
        a(view, obtainNoHistory);
        b(c0Var, obtainNoHistory);
        boolean a3 = c0Var.a(obtainNoHistory, this.i);
