...
public class AlertDialogLayout extends C0170f0 {
    ...
    /* renamed from: a */
    private void m797a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m798c(View view) {
        int m14920l = C3107q2.m14920l(view);
        if (m14920l > 0) {
            return m14920l;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m798c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: c */
    private void m799c(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0170f0.a aVar = (C0170f0.a) childAt.getLayoutParams();
    ...
    /* renamed from: d */
    private boolean m800d(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.f0$a r15 = (androidx.appcompat.widget.C0170f0.a) r15
            int r2 = r15.f1021b
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = p000.C3107q2.m14919k(r17)
            int r2 = p000.C0447b2.m3270a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5
