...
public class C0169f extends CheckBox implements InterfaceC0258j {

    /* renamed from: b */
    private final C0173h f1004b;

    public C0169f(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R$attr.checkboxStyle);
    }

    public C0169f(Context context, AttributeSet attributeSet, int i) {
