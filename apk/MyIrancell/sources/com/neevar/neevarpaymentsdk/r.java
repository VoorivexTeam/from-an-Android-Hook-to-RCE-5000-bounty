...
class r extends AsyncTask<String, Void, String> {
    ...
    public String doInBackground(String... strArr) {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty("Authorization", u.a().a("sdk", str2, str8, str7));
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(SalePaymentActivity.PHONO_NO_PARAM, str2);
            jSONObject.put("SdkInfo", "A1CD3709-1AFB-41E9-A953-FC606362767E");
            jSONObject.put("Sign", "");
            jSONObject.put("PaymentInfo", e.a(f.a(new SecretKeySpec(e.a(str7), "DESede"), (str3 + "," + str4 + "," + str5 + "," + str6 + "," + valueOf + "," + valueOf2 + "," + str2).getBytes("UTF-8"))));
