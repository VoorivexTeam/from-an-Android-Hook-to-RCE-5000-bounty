...
public final class R$styleable {
    ...
    public static final int CropImageView_cancelTextFC = 0;
    public static final int CropImageView_cancelTextFS = 1;
    ...
    public static final int CropImageView_cropFlipHorizontally = 13;
    public static final int CropImageView_cropFlipVertically = 14;
    public static final int CropImageView_cropGuidelines = 15;
    public static final int CropImageView_cropGuidelinesColor = 16;
    public static final int CropImageView_cropGuidelinesThickness = 17;
    public static final int CropImageView_cropInitialCropWindowPaddingRatio = 18;
    public static final int CropImageView_cropMaxCropResultHeightPX = 19;
    public static final int CropImageView_cropMaxCropResultWidthPX = 20;
    public static final int CropImageView_cropMaxZoom = 21;
    public static final int CropImageView_cropMinCropResultHeightPX = 22;
    public static final int CropImageView_cropMinCropResultWidthPX = 23;
    public static final int CropImageView_cropMinCropWindowHeight = 24;
    public static final int CropImageView_cropMinCropWindowWidth = 25;
    public static final int CropImageView_cropMultiTouchEnabled = 26;
    public static final int CropImageView_cropSaveBitmapToInstanceState = 27;
    public static final int CropImageView_cropScaleType = 28;
    public static final int CropImageView_cropScreenStatusbarColor = 29;
    public static final int CropImageView_cropShape = 30;
    public static final int CropImageView_cropShowCropOverlay = 31;
    public static final int CropImageView_cropShowProgressBar = 32;
    public static final int CropImageView_cropSnapRadius = 33;
    public static final int CropImageView_cropTouchRadius = 34;
    public static final int CropImageView_customActionLayoutBGColor = 35;
    public static final int CropImageView_customActionLayoutRequired = 36;
    public static final int CropImageView_doneTextFC = 37;
    public static final int CropImageView_doneTextFS = 38;
    ...
    public static final int[] SeekArc = {R.attr.arcColor, R.attr.arcWidth, R.attr.clockwise, R.attr.enabled, R.attr.max, R.attr.progress, R.attr.progressColor, R.attr.progressWidth, R.attr.rotation, R.attr.roundEdges, R.attr.startAngle, R.attr.sweepAngle, R.attr.thumb, R.attr.thumbOffset, R.attr.touchInside};
