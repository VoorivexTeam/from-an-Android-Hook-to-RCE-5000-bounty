...
public class e extends f0 {
    ...
    public e(Context context, AttributeSet attributeSet, int i) {
        ...
        this.u = true;
        this.v = false;
        TypedArray c = g.c(context, attributeSet, R$styleable.ForegroundLinearLayout, i, 0, new int[0]);
        this.t = c.getInt(R$styleable.ForegroundLinearLayout_android_foregroundGravity, this.t);
        Drawable drawable = c.getDrawable(R$styleable.ForegroundLinearLayout_android_foreground);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.u = c.getBoolean(R$styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
        c.recycle();
    }
